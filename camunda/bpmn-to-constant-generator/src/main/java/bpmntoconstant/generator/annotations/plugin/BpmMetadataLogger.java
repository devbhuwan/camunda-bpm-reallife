...
public class BpmMetadataLogger {
    ...
    private static void printGenericTable(String title, List<String> messages) {
        ...
        table.renderAsCollection().forEach(BpmMetadataLogger::info);
    }
    ...
    public static void printGeneratedTables(boolean debug) {
        ...
        if (generatedTable != null) {
            ...
            generatedTable.renderAsCollection().forEach(BpmMetadataLogger::info);
